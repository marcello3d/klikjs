...
function CRunApp(cName, cfile, path, sub) {
  ...
  var cont = (this.container =
    cName.container || document.createElement("div"));
  ...
  if (pos >= 0) this.resources = path.substring(0, pos + 1);
...
CRunApp.prototype = {
  loadInfo: function () {
    ...
    if (this.infoVersion < 0) this.infoVersion = version;
    ...
    while (chID != 0x7f7f) {
      ...
      switch (chID) {
        ...
        case 0x2223:
          ...
          for (n = 0; n < this.gaNbFrames; n++) this.framePasswords[n] = null;
          break;
        // CHUNK_APPHDR2
        case 0x2245:
  ...
  startApplication: function () {
    ...
    if (this.iOS && this.soundBank.nHandlesReel > 0) {
      // && (this.dwOptions & CRunApp.AH2OPT_LOADSOUNDSONTOUCH) != 0)
    ...
    var n;
    for (n = 0; n < CRunApp.MAX_VK; n++) this.keyBuffer[n] = false;
  ...
  resizeCanvas: function () {
    ...
    if (
      this.dwOptions & CRunApp.AH2OPT_KEEPSCREENRATIO ||
      (this.gaFlags & CRunApp.GA_STRETCH &&
        this.gaFlags & CRunApp.GA_STRETCHTOFIT)
    )
    ...
    if (this.run) this.run.autoResize();
  },
      ...
      if (!this.loading) {
        if (this.parentApp == null) {
          if (this.transitionDisplay == null) {
            this.context.resetEffect(
              (this.dwOptions & CRunApp.AH2OPT_RESAMPLESTRETCH) != 0
            );
            if (!this.previousFrameGraphics) {
              var clearBack = false;
              if (this.frame.leClearBackground)
                this.context.clearBackground(0, 0, this.gaCxWin, this.gaCyWin);
              else
                this.context.renderSolidColor(
                  0,
                  0,
                  this.gaCxWin,
                  this.gaCyWin,
              ...
              this.context.renderSimpleImage(
                this.previousFrameGraphics,
                0,
                0,
                this.gaCxWin,
                this.gaCyWin,
            ...
            if (this.bZoom) {
              ...
              context.scale(
                Math.max(0.001, this.scScaleX),
                Math.max(0.001, this.scScaleY)
              );
            ...
            if (this.joystickOn) this.joystick.draw(this.context);
            if (this.versionCodeDisplay) {
              ...
              if (!this.versionCodeSurface) {
                ...
                font.lfHeight = 16;
                this.versionCodeSurface = new CTextSurface(
                  this,
                  this.gaCxWin,
                  30
                );
                this.versionCodeSurface.manualClear(0xff0000);
                this.versionCodeSurface.manualDrawText(
                  window["FusionVersion"],
                  CServices.DT_CENTER | CServices.DT_VCENTER,
                  null,
                  0xffffff,
                  font,
                  1,
          ...
          if (
            (this.gaNewFlags & CRunApp.GANF_VSYNC) != 0 &&
        ...
        if (this.preloader == null) {
          ...
          if (this.loadPreloader) {
            this.preloader =
              this.preloaderType == 0
                ? new CPreloaderImage(this)
                : new CPreloaderFrame(this);
            if (this.preloaderType == 0 && this.preloaderBackColor != -1)
              color = this.preloaderBackColor;
          } else this.preloader = new CPreloaderDefault(this);
          this.preloaderLoaded = false;
          this.resetted = true;
          if (this.parentApp == null) {
            if (this.frame.leClearBackground)
              this.context.clearBackground(
                0,
                0,
                this.canvas.width,
                this.canvas.height
        ...
        if (this.preloader != null && this.preloaderLoaded == false) {
          ...
          if (this.parentApp == null) this.setUpdate();
          return;
        }

        while (
          this.dataToLoad.size() > 0 &&
          this.dataLoading.size() < this.dataLoadingStep
        ) {
          var data = this.dataToLoad.get(0);
          this.dataLoading.add(data);
          this.dataToLoad.removeIndex(0);
        ...
        if (
          this.preloader != null &&
          ((this.dwOptions & CRunApp.AH2OPT_LOADDATAATSTART) != 0 ||
            (this.frame.html5Options & CRunFrame.HTML5FOPT_DISPLAYPRELOADER) !=
              0)
        ) {
          if (!this.resetted) {
        ...
        if (bComplete) {
          ...
          if (this.bStartFadeIn) {
            ...
            if (quit != 0) this.appRunningState = CRunApp.SL_ENDFRAME;
            else {
  ...
  startTheFrame: function () {
    ...
    if (this.loading) this.run.pause(true);
    else this.run.callComputeNewDisplay();
  },
      ...
      switch (CServices.LOWORD(ul)) {
        case 1:
          ...
          if (
            ...
            this.nextFrame == this.preloaderFrameNumber
          )
            this.nextFrame++;
        ...
        case 2:
          ...
          if (
            ...
            if (this.nextFrame == 0) this.nextFrame = this.currentFrame;
            else this.nextFrame--;
          }
          this.appRunningState = CRunApp.SL_STARTFRAME;
          break;
  ...
  startFrameFadeIn: function (pOldSurf) {
    ...
    if (pData != null) {
      ...
      this.transition = this.getTransitionManager().createTransition(
        pData,
        this.transitionDisplay,
        pSf1,
        pSf2
  ...
  initGlobal: function () {
    ...
    if (
      this.parentApp == null ||
      (this.parentApp != null &&
        (this.parentOptions & CCCA.CCAF_SHARE_LIVES) == 0)
    ) {
    ...
    if (
      this.parentApp == null ||
      (this.parentApp != null &&
        (this.parentOptions & CCCA.CCAF_SHARE_SCORES) == 0)
    ) {
    ...
    } else this.gStrings = null;
  },

  getLives: function () {
    var app = this;
    while (app.lives == null) app = this.parentApp;
    return app.lives;
  },
  getScores: function () {
    var app = this;
    while (app.scores == null) app = this.parentApp;
    return app.scores;
  },
  getCtrlType: function () {
    ...
    while (
      app.parentApp != null &&
      (app.parentOptions & CCCA.CCAF_SHARE_PLAYERCTRLS) != 0
    )
      app = app.parentApp;
  ...
  getGlobalValues: function () {
    var app = this;
    while (app.gValues == null) app = app.parentApp;
    return app.gValues;
  },
  getNGlobalValues: function () {
    if (this.gValues != null) return gValues.length;
    return 0;
  },
  getGlobalStrings: function () {
    var app = this;
    while (app.gStrings == null) app = app.parentApp;
    return app.gStrings;
  },
  getNGlobalStrings: function () {
    if (this.gStrings != null) return gStrings.length;
    return 0;
  },
  checkGlobalValue: function (num) {
    ...
    if (num + 1 > oldSize) {
      var n;
      for (n = oldSize; n < num + 1; n++) values.push(0);
    }
    return values;
  },
  getGlobalValueAt: function (num) {
    var values = this.checkGlobalValue(num);
    if (values != null) return values[num];
    return 0;
  },
  setGlobalValueAt: function (num, value) {
    var values = this.checkGlobalValue(num);
    if (values != null) values[num] = value;
  },
  ...
  doKeyDown: function (e) {
    if (e) {
      ...
      var n;
      for (n = 0; n < this.subApps.length; n++) this.subApps[n].doKeyDown(e);
    }
  },
  doKeyUp: function (e) {
    if (e) {
      ...
      var n;
      for (n = 0; n < this.subApps.length; n++) this.subApps[n].doKeyUp(e);
    }
  },
  ...
  mouseMove: function (e, obj, flag) {
    ...
    var n;
    for (n = 0; n < this.subApps.length; n++) this.subApps[n].mouseMove(e, obj);
  ...
  mouseUp: function (e) {
    ...
    var n;
    for (n = 0; n < this.subApps.length; n++) this.subApps[n].mouseUp(e);
    ...
    if (this.run != null && this.run.rhEvtProg != null) {
      if (pointerEvent) {
        ...
        var nClicks =
          ...
          now - this.mouseDoubleClickTimestamp <=
            CRunApp.MOUSE_DOUBLE_CLICK_DELAY
            ? 2
            : 1;
        this.mouseDoubleClickCode = code;
        ...
        if (this.browserDetect.isIE) {
          ...
          this.run.rhEvtProg.onMouseButton(
  ...
  mouseOut: function (e) {
    ...
    var n;
    for (n = 0; n < this.subApps.length; n++) this.subApps[n].mouseOut(e);
    if (!this.touchable)
      this.touchEnd(new CFakeTouch(e.pageX, e.pageY, this.canvas), false);
  },
  // For IE only
  click: function (e) {
    if (this.browserDetect.isIE) {
      ...
      // Handles clicks
      var n;
      for (n = 0; n < this.subApps.length; n++) this.subApps[n].click(e);
    }
  },
  // For IE only
  dblClick: function (e) {
    if (this.browserDetect.isIE) {
      ...
      var n;
      for (n = 0; n < this.subApps.length; n++) this.subApps[n].dblClick(e);
    }
  },
  mouseWheel: function (e) {
    this.bMouseIn = true;
    if (typeof e.wheelDelta != "undefined") this.deltaWheel = e.wheelDelta / 40;
    else this.deltaWheel = -e.detail;
    if (this.run != null && this.run.rhEvtProg != null)
  ...
  enableSoundsInChrome: function () {
    if (
      ...
      this.soundContext != null &&
      this.soundContext.state == "suspended"
    )
      ...
      for (m = 0; m < CRunApp.MAX_TOUCHES; m++) {
        if (this.touchesID[m] == CRunApp.TOUCHID_EMPTY) {
          ...
          if (!this.bTouchesLocked[m]) {
            ...
            if (
              this.mouseTouch == CRunApp.TOUCHID_EMPTY &&
              touch.identifier != CRunApp.FAKE_TOUCHIDENTIFIER
            ) {
              this.mouseTouch = m;
  ...
  showCursor: function (count) {
    ...
    if (this.cursorCount >= 0) this.canvas.style.cursor = this.cursor;
    else this.canvas.style.cursor = "none";
  },
  ...
  startJoystick: function (type, flags) {
    if (this.joystick == null) {
      ...
      if (
        this.frame != null &&
        (this.frame.html5Options & CRunFrame.HTML5FOPT_JOYSTICK_DPAD) != 0
      ) {
  ...
  endJoystick: function () {
    ...
    if (this.joystickOn == 2) this.endAccelerometer();
    this.joystickOn = 0;
  },
  ...
  getJoystick: function () {
    var joystick = 0;
    if (this.accGravX < -0.2) joystick |= 0x04;
    if (this.accGravX > 0.2) joystick |= 0x08;
    if (this.accGravY < -0.2) joystick |= 0x01;
    if (this.accGravY > 0.2) joystick |= 0x02;
    return joystick;
  },
  ...
  drawContinue: function (preloader) {
    if (preloader.touchMe) {
      if (this.silentSound == null) preloader.touchMePhase = 2;
      ...
      this.context.renderSolidColor(
        preloader.touchMeRect.left,
        preloader.touchMeRect.top,
        preloader.touchMeRect.right - preloader.touchMeRect.left,
        preloader.touchMeRect.bottom - preloader.touchMeRect.top,
        this.frameColor,
        0,
        0
      );
      preloader.touchMe.draw(
        this.context,
        preloader.touchMeRect.left,
        preloader.touchMeRect.top,
        CRSpr.BOP_BLEND,
        preloader.touchMeAlpha
      );
      ...
      if (
        ...
        var width =
          preloader.touchMe.measureText(this.m_touchMe, preloader.touchMeFont) +
          64;
        preloader.touchMe.resize(width, height);
        preloader.touchMe.manualClear();
        preloader.touchMe.manualDrawText(
          this.m_touchMe,
          CServices.DT_VCENTER | CServices.DT_CENTER,
          null,
          0xffff00,
          preloader.touchMeFont,
          2,
          0x000000
        );
    ...
    while (chID != 0x7f7f) {
      ...
      switch (chID) {
        case 0x3334:
          this.loadHeader();
          if (
            this.app.parentApp != null &&
            (this.app.parentOptions & CCCA.CCAF_DOCKED) != 0
          ) {
...
function CSoundPlayer(a) {
  ...
  for (n = 0; n < 4; n++) {
    if (canPlay[n] == "probably") this.probablePlayableFormats |= 1 << n;
    if (canPlay[n] == "maybe") this.maybePlayableFormats |= 1 << n;
  }

  // Use WEB AUDIO?
  var papp = a;
  while (papp.parentApp != null) papp = papp.parentApp;
...
CSoundPlayer.prototype = {
  addDataToDecode: function (cSound) {
    if (this.dataToDecode == null) this.dataToDecode = new CArrayList();
  ...
  play: function (handle, nLoops, channel, bPrio) {
    ...
    if (this.bOn == false) return;

    var sound = this.app.soundBank.getSoundFromHandle(handle);
    if (sound == null) return;
    if (this.bMultipleSounds == false) channel = 0;
    /*      	else
		 {
		 for (n = 0; n < CSoundPlayer.NCHANNELS; n++)
		 {
    ...
    if (channel < 0 || channel >= CSoundPlayer.NCHANNELS) return;

    if (this.channels[channel] != null) {
      if (this.channels[channel].bUninterruptible == true) return;
  ...
  setOnOff: function (bState) {
    if (bState != bOn) {
      this.bOn = bState;
      if (this.bOn == false) this.stopAllSounds();
    }
  },
  ...
  isSoundPlaying: function () {
    ...
    for (c = 0; c < CSoundPlayer.NCHANNELS; c++) {
      if (this.channels[c] != null) {
        if (this.channels[c].isPlaying()) return true;
      }
    }
    return false;
  },
...
function CPreloaderImage(a) {
  ...
  if (this.xCenter < 0) this.xCenter = this.app.gaCxWin / 2;
  this.yCenter = this.app.preloaderCircleCenterY;
  if (this.yCenter < 0) this.yCenter = this.app.gaCyWin / 2;
  this.currentAngle = 0;
  ...
  step: function () {
    switch (this.phase) {
      case 0:
        ...
        this.context.renderSimpleImage(
          this.image,
          this.xCenter - this.image.width / 2,
          this.yCenter - this.image.height / 2,
          this.image.width,
          this.image.height,
          0,
          0
      ...
      case 1:
        this.angle =
          (this.app.imagesLoaded / this.app.imagesToLoad) * 2 * Math.PI;
        this.drawIt(this.angle);
        if (this.app.imagesLoaded == this.app.imagesToLoad) this.phase++;
        break;
      case 2:
        if (this.counter > 0) this.counter--;
        if (this.counter == 0) this.phase++;
        break;
      case 3:
        if (this.app.drawContinue(this)) this.phase++;
        break;
      default:
        break;
    }
...
CPreloaderDefault.prototype = {
  ...
  step: function () {
    if (this.app.imagesLoaded < this.app.imagesToLoad) {
      ...
      switch (this.phase) {
        ...
        case 2:
          ...
          if (this.alpha >= 128) {
            this.alpha = 128;
            if (this.app.silentSound == null) this.quit = true;
            else this.phase++;
          }
          break;
        default:
    ...
    this.position =
      (this.app.imagesLoaded / this.app.imagesToLoad) * (this.width - 2);
    this.context.renderSolidColor(
      this.rect.left + 1,
      this.rect.top + 1,
      this.position,
...
function CPreloaderFrame(a) {
  ...
  this.subApp.setParentApp(
    this.app,
    this.app.preloaderFrameNumber,
    0,
    this.appSprite,
    this.app.gaCxWin,
    this.app.gaCyWin
...
CPreloaderFrame.prototype = {
  ...
  step: function () {
    if (!this.subApp.subAppStopped) {
      if (this.stopOnLoad)
        this.subApp.subAppStopped =
          this.app.imagesLoaded == this.app.imagesToLoad;
      if (this.subApp.stepApplication() == false)
        this.subApp.subAppStopped = true;
      this.subApp.drawSubApplication(
        this.context,
        this.appSprite.x,
        this.appSprite.y,
        false
  ...
  isComplete: function () {
    ...
    if (this.app.silentSound) bComplete = false;
    if (bComplete) {
      if (this.delay > 0) {
        this.delay--;
...
CJoystick.prototype = {
  loadImages: function () {
    ...
    if (
      this.joyUp == null &&
      (this.app.frame.html5Options & CRunFrame.HTML5FOPT_JOYSTICK_DPAD) != 0
    ) {
      // need to test the frame option, as this.flags may not be initialized yet
  ...
  reset: function (f) {
    ...
    if (this.joyBack != null && this.joyBack.width != 0) this.setPositions();
    else this.bSetPositions = true;
  ...
  setPositions: function () {
    ...
    if ((this.flags & CJoystick.JFLAG_DPAD) != 0) {
      this.joyradsize = Math.ceil(
        Math.sqrt(
          this.joyLeft.width * this.joyLeft.width +
            this.joyUp.height * this.joyUp.height
        )
      );
    } else {
      this.joyradsize = Math.ceil(
        Math.sqrt(
          ((this.joyBack.width / 2) * this.joyBack.width) / 2 +
            ((this.joyBack.height / 2) * this.joyBack.height) / 2
        )
      );
    }
    ...
    if ((this.flags & CJoystick.JFLAG_LEFTHANDED) == 0) {
      if ((this.flags & CJoystick.JFLAG_JOYSTICK) != 0) {
        if ((this.flags & CJoystick.JFLAG_DPAD) != 0) {
          ...
          this.imagesY[CJoystick.KEY_JOYSTICK] =
            sy - 16 - this.joyBack.height / 2;
        }
      }
      if (
        (this.flags & CJoystick.JFLAG_FIRE1) != 0 &&
        (this.flags & CJoystick.JFLAG_FIRE2) != 0
      ) {
        ...
        this.imagesY[CJoystick.KEY_FIRE2] =
          sy - this.fire2U.height / 2 - this.fire1U.height - 24;
      ...
      if ((this.flags & CJoystick.JFLAG_JOYSTICK) != 0) {
        if ((this.flags & CJoystick.JFLAG_DPAD) != 0) {
          ...
          this.imagesX[CJoystick.KEY_JOYSTICK] =
            sx - 16 - this.joyBack.width / 2;
          this.imagesY[CJoystick.KEY_JOYSTICK] =
            sy - 16 - this.joyBack.height / 2;
        }
      }
      if (
        ...
        this.imagesX[CJoystick.KEY_FIRE1] =
          this.fire1U.width / 2 + 16 + (this.fire2U.width * 2) / 3;
        this.imagesY[CJoystick.KEY_FIRE1] = sy - this.fire1U.height / 2 - 16;
    ...
    if ((this.flags & CJoystick.JFLAG_JOYSTICK) != 0) {
      if ((this.flags & CJoystick.JFLAG_DPAD) != 0) {
        ...
        x =
          this.imagesX[CJoystick.KEY_JOYSTICK] +
          this.joystickX -
          this.joyFront.width / 2;
        y =
          this.imagesY[CJoystick.KEY_JOYSTICK] +
          this.joystickY -
          this.joyFront.height / 2;
  ...
  updateJoystickState: function (x, y) {
    ...
    var angle =
      (Math.PI * 2 - Math.atan2(this.joystickY, this.joystickX)) %
      (Math.PI * 2);
    this.joystick &= 0xf0;
    var h = Math.sqrt(
      this.joystickX * this.joystickX + this.joystickY * this.joystickY
    );
    ...
    if (h > this.joydeadzone && h <= this.joyradsize) {
      ...
      if (angle >= 0.0) {
        while (true) {
          // Right
          if (
            this.insideZone(angle, 0, this.joyanglezone) ||
            this.insideZone(angle, Math.PI * 2, this.joyanglezone)
          ) {
            j = 8;
            break;
          }
          ...
          // Right/Up
          if (
            this.insideZone(angle, Math.PI / 4, Math.PI / 2 - this.joyanglezone)
          ) {
            j = 9;
            break;
          }
  ...
  getKey: function (x, y) {
    if ((this.flags & CJoystick.JFLAG_JOYSTICK) != 0) {
      if ((this.flags & CJoystick.JFLAG_DPAD) != 0) {
        if (
          x >= this.imagesX[CJoystick.KEY_JOYSTICK] - this.joyLeft.width &&
          x < this.imagesX[CJoystick.KEY_JOYSTICK] + this.joyRight.width
        ) {
          if (
            y > this.imagesY[CJoystick.KEY_JOYSTICK] - this.joyUp.height &&
            y < this.imagesY[CJoystick.KEY_JOYSTICK] + this.joyDown.height
          ) {
        ...
        if (
          ...
          if (
            y >
              this.imagesY[CJoystick.KEY_JOYSTICK] - this.joyBack.height / 2 &&
            y < this.imagesY[CJoystick.KEY_JOYSTICK] + this.joyBack.height / 2
          ) {
            return CJoystick.KEY_JOYSTICK;
          }
    ...
    if ((this.flags & CJoystick.JFLAG_FIRE1) != 0) {
      if (
        x >= this.imagesX[CJoystick.KEY_FIRE1] - this.fire1U.width / 2 &&
        x < this.imagesX[CJoystick.KEY_FIRE1] + this.fire1U.width / 2
      ) {
        if (
          y > this.imagesY[CJoystick.KEY_FIRE1] - this.fire1U.height / 2 &&
          y < this.imagesY[CJoystick.KEY_FIRE1] + this.fire1U.height / 2
        ) {
    ...
    if ((this.flags & CJoystick.JFLAG_FIRE2) != 0) {
      if (
        x >= this.imagesX[CJoystick.KEY_FIRE2] - this.fire2U.width / 2 &&
        x < this.imagesX[CJoystick.KEY_FIRE2] + this.fire2U.width / 2
      ) {
        if (
          y > this.imagesY[CJoystick.KEY_FIRE2] - this.fire2U.height / 2 &&
          y < this.imagesY[CJoystick.KEY_FIRE2] + this.fire2U.height / 2
        ) {
